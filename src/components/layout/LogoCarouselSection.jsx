        ...
        <section className="w-full px-10 py-10">
            <div className="flex flex-col gap-20">
                ...
                <div className="flex justify-between">
                    <p className="font-semibold tracking-[0.025rem] text-[clamp(0.65rem,1vw,0.80rem)]">Recognized by</p>
                    <p className="font-medium max-w-2xl tracking-[0.025rem] text-[clamp(1rem,1.2vw,1.375rem)]">
